...
public class WebTableExample {
    ...
    public void printTableSize(){
        ...
        System.out.println("NUmber of rows: " + allRowsWithoutHeader.size());
    }
    ...
    public void getRow() {
        ...
        List<WebElement> allRows = driver.findElements(By.xpath("//*[@id='table1']/tbody/tr"));

        for (int i = 1; i <= allRows.size(); i++) {

            String rowXpath = "//*[@id='table1']/tbody/tr[" + i + "]";
    ...
    public void getCellInRelationToAnotherCellInSameRow(){
        ...
        String xpath = "//table[@id='table1']//td[.='Tim']/../td[3]";
